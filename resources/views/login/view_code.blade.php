  ...
  <div class="container mt-5">
    ...
    @endif
        <form id="reset_password" action="{{ route('reset_password') }}" method="get">
          ...
          <div class="mb-3 input-group">
            <input type="password" class="form-control" id="resetpassword" name="resetpassword" placeholder="Nhập lại mật khẩu" required>
            <span class="input-group-text"><i class="fas fa-lock" style="color:red"></i></span>
          </div>
          <div class="text-center">
            <button type="submit" class=" btn btn-success btn-block mb-2"><i class="fas fa-sign-in-alt"></i> Thay đổi mật khẩu</button>
          </div>
          @csrf
        </form>
        <div class="text-center">
