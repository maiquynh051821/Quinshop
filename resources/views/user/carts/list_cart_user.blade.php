                                ...
                                <td class="">
                                    <div class="d-flex">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="">
                                                                    <div class="feedback">
                                                                        <div
                                                                            class="rating{{ $key }}{{ $vitri }}">
                                                                            <input type="radio" name="rating"
                                                                                id="rating{{ $key }}{{ $vitri }}-5"
                                                                                value="5">
                                                                            <label
                                                                                for="rating{{ $key }}{{ $vitri }}-5"></label>
                                                                            <input type="radio" name="rating"
                                                                                id="rating{{ $key }}{{ $vitri }}-4"
                                                                                value="4">
                                                                            <label
                                                                                for="rating{{ $key }}{{ $vitri }}-4"></label>
                                                                            <input type="radio" name="rating"
                                                                                id="rating{{ $key }}{{ $vitri }}-3"
                                                                                value="3">
                                                                            <label
                                                                                for="rating{{ $key }}{{ $vitri }}-3"></label>
                                                                            <input type="radio" name="rating"
                                                                                id="rating{{ $key }}{{ $vitri }}-2"
                                                                                value="2">
                                                                            <label
                                                                                for="rating{{ $key }}{{ $vitri }}-2"></label>
                                                                            <input type="radio" name="rating"
                                                                                id="rating{{ $key }}{{ $vitri }}-1"
                                                                                value="1">
                                                                            <label
                                                                                for="rating{{ $key }}{{ $vitri }}-1"></label>
                                                                ...
                                                                <div>
                                                                    <textarea class="form-control" name="comment" id="" width="100%" rows="10"></textarea>
                                                                </div>
                                                            </div>
                                        ...
                                        @if ($cart->cart_status == 3)
                                            <p class="font-weight-bold mb-0 text-white px-2"
                                                style="background: rgb(128, 0, 23); border-radius: 10px">Đơn hàng đã hủy
                                            </p>
                                        @endif
                                    </div>
