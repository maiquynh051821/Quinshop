        ...
        <div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="">
                    <div class="feedback">
                      <div class="rating0">
                        <input type="radio" @if($rating > 4 && $rating <= 5) checked  @endif name="rating" id="rating0-5" value="5">
                        <label for="rating0-5"></label>
                        <input type="radio"  @if($rating > 3 && $rating <= 4) checked  @endif name="rating" id="rating0-4" value="4">
                        <label for="rating0-4"></label>
                        <input type="radio"  @if($rating > 2 && $rating <= 3) checked  @endif name="rating" id="rating0-3" value="3">
                        <label for="rating0-3"></label>
                        <input type="radio"  @if($rating > 1 && $rating <= 2) checked  @endif name="rating" id="rating0-2" value="2">
                        <label for="rating0-2"></label>
                        <input type="radio"  @if(  $rating <= 1) checked  @endif name="rating" id="rating0-1" value="1">
            ...
            <ul>
                ...
                <li class="text-uppercase">{{ $commentItem->COMMENT }}</li>
                @endforeach
                <li></li>
            </ul>
        </div>
