...
<section class="product">
    <div class="container">
        <div class="product-top">
           <a href="/"><p>Trang chủ</p></a><span>&#10230;</span>
            <a href="/danh-muc/{{$product->menu->id}}-{{\Str::slug($product->menu->name)}}.html">
                <p>{{$product->menu->name}}</p></a><span>&#10230;</span>
            <p>{{$product->name}}</p>
        </div>
        <div class="product-content">
            ...
            <div class="product-content-right">
                ...
                <div class="product-content-right-price">
                    <p><span style="font-weight: bold;color:black;">Giá :</span> {!! \App\Helpers\Helper::price($product->price_sale) !!} <sup>đ </sup>
                        <del style="color: rgb(68, 67, 67);font-weight:80"><span>{!! \App\Helpers\Helper::price($product->price) !!}<sup>đ</sup></span></del></p>
